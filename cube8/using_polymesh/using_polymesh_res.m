...
DEBUG                     (idx, 1)        = 0 ;
TITLE                     (idx, [1: 23])  = '8 cubes hexahedron test' ;
CONFIDENTIAL_DATA         (idx, 1)        = 0 ;
INPUT_FILE_NAME           (idx, [1: 45])  = './Sandbox/cube8/using_polymesh/using_polymesh' ;
...
CPU_MHZ                   (idx, 1)        = 27.0 ;
START_DATE                (idx, [1: 24])  = 'Sat Feb  4 18:33:25 2017' ;
COMPLETE_DATE             (idx, [1: 24])  = 'Sat Feb  4 18:33:34 2017' ;
...
ST_FRAC                   (idx, [1:   4]) = [  3.59430E-02 0.0E+00  0.00000E+00 0.0E+00 ];
DT_FRAC                   (idx, [1:   4]) = [  9.64057E-01 0.0E+00  0.00000E+00 0.0E+00 ];
DT_EFF                    (idx, [1:   4]) = [  7.62442E-01 0.0E+00  0.00000E+00 0.0E+00 ];
REA_SAMPLING_EFF          (idx, [1:   4]) = [  1.00000E+00 0.0E+00  0.00000E+00 0.0E+00 ];
REA_SAMPLING_FAIL         (idx, [1:   4]) = [  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00 ];
TOT_COL_EFF               (idx, [1:   4]) = [  7.46045E-01 0.0E+00  0.00000E+00 0.0E+00 ];
AVG_TRACKING_LOOPS        (idx, [1:   8]) = [  3.36763E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00 ];
AVG_TRACKS                (idx, [1:   4]) = [  3.73189E+01 0.0E+00  0.00000E+00 0.0E+00 ];
AVG_REAL_COL              (idx, [1:   4]) = [  3.70472E+01 0.0E+00  0.00000E+00 0.0E+00 ];
AVG_VIRT_COL              (idx, [1:   4]) = [  1.26109E+01 0.0E+00  0.00000E+00 0.0E+00 ];
AVG_SURF_CROSS            (idx, [1:   4]) = [  4.78664E-01 0.0E+00  0.00000E+00 0.0E+00 ];
LOST_PARTICLES            (idx, 1)        = 0 ;

% Run statistics:

CYCLE_IDX                 (idx, 1)        = 1 ;
SOURCE_POPULATION         (idx, 1)        = 16076 ;
MEAN_POP_SIZE             (idx, [1:  2])  = [  1.60760E+04 0.00000 ];
MEAN_POP_WGT              (idx, [1:  2])  = [  1.60760E+04 0.00000 ];
SIMULATION_COMPLETED      (idx, 1)        = 1 ;

% Running times:

TOT_CPU_TIME              (idx, 1)        =  1.38590E-01 ;
RUNNING_TIME              (idx, 1)        =  1.45700E-01 ;
INIT_TIME                 (idx, [1:  2])  = [  3.68167E-02  3.68167E-02 ];
PROCESS_TIME              (idx, [1:  2])  = [  2.33333E-03  2.33333E-03 ];
TRANSPORT_CYCLE_TIME      (idx, [1:  3])  = [  1.06550E-01  1.06550E-01  0.00000E+00 ];
MPI_OVERHEAD_TIME         (idx, [1:  2])  = [  0.00000E+00  0.00000E+00 ];
ESTIMATED_RUNNING_TIME    (idx, [1:  2])  = [  1.45667E-01  0.00000E+00 ];
CPU_USAGE                 (idx, 1)        = 0.95120 ;
TRANSPORT_CPU_USAGE       (idx, [1:   2]) = [  9.89556E-01 0.0E+00 ];
OMP_PARALLEL_FRAC         (idx, 1)        =  7.54290E-01 ;

% Memory usage:

AVAIL_MEM                 (idx, 1)        = 974.91 ;
ALLOC_MEMSIZE             (idx, 1)        = 269.34;
MEMSIZE                   (idx, 1)        = 211.40;
XS_MEMSIZE                (idx, 1)        = 21.34;
MAT_MEMSIZE               (idx, 1)        = 11.21;
RES_MEMSIZE               (idx, 1)        = 149.48;
MISC_MEMSIZE              (idx, 1)        = 29.38;
UNKNOWN_MEMSIZE           (idx, 1)        = 0.00;
UNUSED_MEMSIZE            (idx, 1)        = 57.94;
...
NORM_COEF                 (idx, [1:   4]) = [  1.66904E+08 0.0E+00  0.00000E+00 0.0E+00 ];

% Analog reaction rate estimators:

CONVERSION_RATIO          (idx, [1:   2]) = [  9.94705E-03 0.0E+00 ];
TH232_FISS                (idx, [1:   4]) = [  1.27784E+14 0.0E+00  7.98779E-01 0.0E+00 ];
U233_FISS                 (idx, [1:   4]) = [  3.21900E+13 0.0E+00  2.01221E-01 0.0E+00 ];
TH232_CAPT                (idx, [1:   4]) = [  3.20446E+11 0.0E+00  8.99068E-01 0.0E+00 ];
U233_CAPT                 (idx, [1:   4]) = [  2.51249E+10 0.0E+00  7.04923E-02 0.0E+00 ];

% Neutron balance (particles/weight):

BALA_SRC_NEUTRON_SRC        (idx, [1:  2])  = [ 0 0.00000E+00 ];
BALA_SRC_NEUTRON_FISS       (idx, [1:  2])  = [ 5364 5.36400E+03 ];
BALA_SRC_NEUTRON_NXN        (idx, [1:  2])  = [ 0 7.15352E+00 ];
BALA_SRC_NEUTRON_VR         (idx, [1:  2])  = [ 0 0.00000E+00 ];
BALA_SRC_NEUTRON_TOT        (idx, [1:  2])  = [ 5364 5.37115E+03 ];

BALA_LOSS_NEUTRON_CAPT       (idx, [1:  2])  = [ 6856 2.13548E+03 ];
BALA_LOSS_NEUTRON_FISS       (idx, [1:  2])  = [ 3077246 9.58479E+05 ];
BALA_LOSS_NEUTRON_LEAK       (idx, [1:  2])  = [ 4369 1.36135E+03 ];
BALA_LOSS_NEUTRON_CUT        (idx, [1:  2])  = [ 0 0.00000E+00 ];
BALA_LOSS_NEUTRON_TOT        (idx, [1:  2])  = [ 3088471 9.61976E+05 ];

% Normalized total reaction rates (neutrons):

TOT_POWER                 (idx, [1:   2]) = [  8.00000E+00 0.0E+00 ];
TOT_POWDENS               (idx, [1:   2]) = [  5.64926E-10 0.0E+00 ];
TOT_GENRATE               (idx, [1:   2]) = [  6.28285E+11 0.0E+00 ];
TOT_FISSRATE              (idx, [1:   2]) = [  2.50643E+11 0.0E+00 ];
TOT_CAPTRATE              (idx, [1:   2]) = [  3.59899E+11 0.0E+00 ];
TOT_ABSRATE               (idx, [1:   2]) = [  6.10542E+11 0.0E+00 ];
TOT_SRCRATE               (idx, [1:   2]) = [  8.34519E+11 0.0E+00 ];
TOT_FLUX                  (idx, [1:   2]) = [  1.51410E+14 0.0E+00 ];
TOT_PHOTON_PRODRATE       (idx, [1:   4]) = [  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00 ];
TOT_LEAKRATE              (idx, [1:   2]) = [  2.27214E+11 0.0E+00 ];
ALBEDO_LEAKRATE           (idx, [1:   2]) = [  0.00000E+00 0.0E+00 ];
TOT_LOSSRATE              (idx, [1:   2]) = [  8.37756E+11 0.0E+00 ];
TOT_CUTRATE               (idx, [1:   2]) = [  0.00000E+00 0.0E+00 ];
TOT_RR                    (idx, [1:   2]) = [  3.09601E+13 0.0E+00 ];
INI_FMASS                 (idx, 1)        =  1.41611E+04 ;
TOT_FMASS                 (idx, 1)        =  1.41611E+04 ;

% Fission neutron and energy production:

NUBAR                     (idx, [1:   2]) = [  2.50670E+00 0.0E+00 ];
FISSE                     (idx, [1:   2]) = [  1.99216E+02 0.0E+00 ];

% Criticality eigenvalues:

ANA_KEFF                  (idx, [1:   6]) = [  7.07987E-01 0.0E+00  9.05983E+00 0.0E+00  3.12459E-02 0.0E+00 ];
IMP_KEFF                  (idx, [1:   2]) = [  7.50817E-01 0.0E+00 ];
COL_KEFF                  (idx, [1:   2]) = [  7.52871E-01 0.0E+00 ];
ABS_KEFF                  (idx, [1:   2]) = [  7.50817E-01 0.0E+00 ];
ABS_KINF                  (idx, [1:   2]) = [  1.03067E+00 0.0E+00 ];
GEOM_ALBEDO               (idx, [1:   6]) = [  1.00000E+00 0.0E+00  1.00000E+00 0.0E+00  1.00000E+00 0.0E+00 ];

% Forward-weighted delayed neutron parameters:

FWD_ANA_BETA_ZERO         (idx, [1:  18]) = [  1.32197E-03 0.0E+00  0.00000E+00 0.0E+00  1.65246E-04 0.0E+00  0.00000E+00 0.0E+00  6.60984E-04 0.0E+00  3.30492E-04 0.0E+00  0.00000E+00 0.0E+00  1.65246E-04 0.0E+00  0.00000E+00 0.0E+00 ];
FWD_ANA_LAMBDA            (idx, [1:  18]) = [  3.47522E-01 0.0E+00  0.00000E+00 0.0E+00  2.82917E-02 0.0E+00  0.00000E+00 0.0E+00  1.33042E-01 0.0E+00  2.92467E-01 0.0E+00  0.00000E+00 0.0E+00  1.63478E+00 0.0E+00  0.00000E+00 0.0E+00 ];

% Beta-eff using Meulekamp's method:

ADJ_MEULEKAMP_BETA_EFF    (idx, [1:  18]) = [  4.03464E-03 0.0E+00  8.78028E-04 0.0E+00  7.51713E-04 0.0E+00  1.75327E-04 0.0E+00  4.99630E-04 0.0E+00  1.51760E-03 0.0E+00  1.49077E-04 0.0E+00  2.48638E-05 0.0E+00  3.84023E-05 0.0E+00 ];
ADJ_MEULEKAMP_LAMBDA      (idx, [1:  18]) = [  2.04851E-01 0.0E+00  1.24667E-02 0.0E+00  2.82917E-02 0.0E+00  4.25244E-02 0.0E+00  1.33042E-01 0.0E+00  2.92467E-01 0.0E+00  6.66488E-01 0.0E+00  1.63478E+00 0.0E+00  3.55460E+00 0.0E+00 ];

% Adjoint weighted time constants using Nauchi's method:

ADJ_NAUCHI_GEN_TIME       (idx, [1:   6]) = [  1.72560E-06 0.0E+00  1.72560E-06 0.0E+00  0.00000E+00 0.0E+00 ];
ADJ_NAUCHI_LIFETIME       (idx, [1:   6]) = [  1.22170E-06 0.0E+00  1.22170E-06 0.0E+00  0.00000E+00 0.0E+00 ];
ADJ_NAUCHI_BETA_EFF       (idx, [1:  18]) = [  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00 ];
ADJ_NAUCHI_LAMBDA         (idx, [1:  18]) = [  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00  0.00000E+00 0.0E+00 ];
...
ADJ_PERT_GEN_TIME         (idx, [1:   2]) = [  5.53707E-07 0.0E+00 ];
ADJ_PERT_LIFETIME         (idx, [1:   2]) = [  3.92018E-07 0.0E+00 ];
ADJ_PERT_BETA_EFF         (idx, [1:   2]) = [  3.08896E-04 0.0E+00 ];
ADJ_PERT_ROSSI_ALPHA      (idx, [1:   2]) = [ -5.57869E+02 0.0E+00 ];

% Inverse neutron speed :

ANA_INV_SPD               (idx, [1:   2]) = [  6.42301E-09 0.0E+00 ];
...
ANA_DELAYED_EMTIME        (idx, [1:   2]) = [  2.35940E+01 0.0E+00 ];
ANA_MEAN_NCOL             (idx, [1:   4]) = [  3.70472E+01 0.0E+00  4.10579E+01 0.0E+00 ];
...
BETA_EFF                  (idx, [1:  18]) = [  4.03464E-03 0.0E+00  8.78028E-04 0.0E+00  7.51713E-04 0.0E+00  1.75327E-04 0.0E+00  4.99630E-04 0.0E+00  1.51760E-03 0.0E+00  1.49077E-04 0.0E+00  2.48638E-05 0.0E+00  3.84023E-05 0.0E+00 ];
LAMBDA                    (idx, [1:  18]) = [  2.04851E-01 0.0E+00  1.24667E-02 0.0E+00  2.82917E-02 0.0E+00  4.25244E-02 0.0E+00  1.33042E-01 0.0E+00  2.92467E-01 0.0E+00  6.66488E-01 0.0E+00  1.63478E+00 0.0E+00  3.55460E+00 0.0E+00 ];
